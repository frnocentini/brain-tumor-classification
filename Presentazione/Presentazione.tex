...
%		Inoltre è possibile dar maggior robustezza con strati di \textbf{BatchNormalization}.
		%La normalizzazione batch scala gli output dei livelli della CNN in modo 
		%che abbiano media 0 e varianza 1.\\
		...
		% dei parametri.
		%Normalizzare i dati uniforma la varianza e la dev std così che la
		% funzione di costo da minimizzare
		%sia più simmetrica e sia possibile utilizzare un learning rate 
		%più grande così da apprendere più velocemente
